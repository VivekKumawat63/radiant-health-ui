...
ALTER TABLE public.profiles ADD COLUMN role public.user_role DEFAULT 'patient' NOT NULL;

-- Update the handle_new_user function to store role
...
BEGIN
  ...
  -- Only create sample data for patients
  IF user_role = 'patient' OR user_role IS NULL THEN
