      ...
      <div className="flex items-center gap-4">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent className="w-56" align="end" forceMount>
            ...
            <DropdownMenuItem onClick={() => navigate('/settings')}>Medical Preferences</DropdownMenuItem>
            <DropdownMenuItem onClick={() => navigate('/settings')}>Privacy Settings</DropdownMenuItem>
            <DropdownMenuSeparator />
